...
const highproteinmeal = ["images/r1.png", "images/r2.png", "images/r3.png","images/r4.png","images/r5.png","images/r6.png","images/r7.png"]; // Add paths to all rich images
let highpro=[...highproteinmeal];
const lowproteinmeal  = ["images/p1.png", "images/p2.png", "images/p3.png","images/p4.png","images/p5.png","images/p6.png", "images/sugar.png"]; // Add paths to all poor images
let lowpro=[...lowproteinmeal];
...
function setMole() {
    ...
    mole.src = getRandomImage(highpro,highproteinmeal);
...
function setPlant() {
    ...
    plant.src = getRandomImage(lowpro,lowproteinmeal);
