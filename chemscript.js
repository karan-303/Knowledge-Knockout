...
let moleInterval;
let plantInterval;
const acidImages = ["images/salt.png","images/sugar.png", "images/milk.png", "images/lemon_juice.png", "images/glucose.png", "images/ink.png","images/coffee.png"] ; // Add paths to all acid images
let acidic=[...acidImages];
const baseImages = ["images/chalk.png","images/sand.png", "images/candle.png", "images/eraser.png", "images/glass.png", "images/oil.png", "images/scale.png"]; // Add paths to all base images
let basic=[...baseImages];
...
function setMole() {
    ...
    mole.src = getRandomImage(acidic,acidImages);
...
function setPlant() {
    ...
    plant.src = getRandomImage(basic,baseImages);
...
function resetGame() {
    ...
    gameOver = false;
    document.getElementById("live_score").innerText = score.toString();
    document.getElementById("time_left").innerText = "20";
